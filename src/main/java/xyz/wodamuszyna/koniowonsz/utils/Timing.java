...
public class Timing {
    ...
    public String toString() {
        return String.valueOf(String.valueOf(String.valueOf(String.valueOf(this.name)))) +
                " executing time: " + getExecutingTime() + "ms (" +
                getExecutingNanoTime() + "ns)";
    }
    ...
    public long getNanoStartTime() { return this.nanoStartTime; }



    public long getNanoEndTime() { return this.nanoEndTime; }
